...
public class Config {
    ...
    public static final String WINNING_NUMBER_SIZE_ERROR_MESSAGE = "입력된 당첨 번호의 수가 잘못되었습니다.";
    ...
    public static final String WINNING_NUMBER_FORMAT_ERROR_MESSAGE = "당첨 번호는 숫자로 이루어져 있습니다.";
